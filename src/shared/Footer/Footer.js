...
const Footer = () => {
    ...
    return (
        <footer className="bg-base-200">
          <div className='footer py-10 bg-base-200 text-base-content xl:max-w-[1140px] lg:max-w-[90%] md:max-w-[90%] sm:max-w-[90%] w-[90%] mx-auto'>
            <div>
                <div>
              ...
              <p>WholeSale Industries Ltd.<br/>Providing reliable tech since 1990</p>
            </div> 
            <div>
              <span className="footer-title">Primary Menu</span> 
                <Link to={'/'}>Home</Link>
